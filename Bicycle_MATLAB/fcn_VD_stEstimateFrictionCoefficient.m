function friction_coefficient = fcn_VD_stEstimateFrictionCoefficient(...
                                slip_angle, normal_force, aligning_moment, ...
                                vehicle)
%% fcn_VD_stEstimateFrictionCoefficient
...
% FORMAT:
%
%   friction_coefficient = fcn_VD_stEstimateFrictionCoefficient(...
%   slip_angle, normal_force, aligning_moment, vehicle)
%
% INPUTS:
%
%   slip_angle: A 2x1 vector of slip-angles.
%   normal_force: A 2x1 vector of normal forces.
%   aligning_moment: A 2x1 vector of aligning moment.
%   vehicle: MATLAB structure containing vehicle properties.
%
% OUTPUTS:
%
%   friction_coefficient: A 2x1 vector of friction coefficient.
%   [Front; Rear]
%
...
if flag_check_inputs
	...
	% Check the aligning_moment input to be sure it has 2 col, 1+ rows
	fcn_DebugTools_checkInputsToFunctions(aligning_moment, '2column_of_numbers',[1 2]);
...
friction_force = nan(2,1); % initialize output variable
