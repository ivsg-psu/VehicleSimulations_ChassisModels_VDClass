function body_variable = fcn_VD_stWheel2BodyCoordinates(wheel_variable,...
                         steering_angle)
%% fcn_VD_stWheel2BodyCoordinates
%   This function transforms variables from wheel to body coordinates
%   It uses single-track\bicycle vehicle model.
%
% FORMAT:
%
%   body_variable = fcn_VD_stWheel2BodyCoordinates(wheel_variable,...
%                   steering_angle)
%
% INPUTS:
%
...
if flag_check_inputs
	...
	% Check the wheel_variable input to be sure it has 2 col, 2 rows
	fcn_DebugTools_checkInputsToFunctions(wheel_variable, '2column_of_numbers',[2 2]);
