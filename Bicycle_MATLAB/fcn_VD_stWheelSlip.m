...
if flag_check_inputs
	...
	% Check the wheel_angular_velocity input to be sure it has 2 col, 1+ rows
	fcn_DebugTools_checkInputsToFunctions(wheel_angular_velocity, '2column_of_numbers',[1 2]);
