function [stateTrajectory, t, steeringUsed] = fcn_VD_body2GlobalCoordinateRK4(initialStates, deltaT, timeInterval, inputsVsTime, parameters, varargin)

%% fcn_VD_body2GlobalCoordinateRK4
%   Simulates the body-fixed to global coordinate conversion using Runga
%   Kutta 4th-order
%
% FORMAT:
%
%      [stateTrajectory, t, steeringUsed] =
%      fcn_VD_body2GlobalCoordinateRK4(initialStates, deltaT,
...
% EXAMPLES:
%
%     See the script: script_test_fcn_VD_body2GlobalCoordinateRK4
%     for a full test suite.
%
% This function was written on 2026_09_10 
...
% - First write of fcn_VD_body2GlobalCoordinateRK4 function
%
% As: fcn_VD_body2GlobalCoordinateRK4
%
...
for ith_time = 1:N_timeSteps
	...
	yawRate = steeringUsed(ith_time,1);
