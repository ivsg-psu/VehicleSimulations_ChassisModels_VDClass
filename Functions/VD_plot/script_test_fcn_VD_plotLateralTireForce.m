% script_test_fcn_VD_plotTimeLateralTireForce.m
% tests fcn_VD_plotTimeLateralTireForce.m

% REVISION HISTORY:
%
% 2026_01_07 by Sean Brennan, sbrennan@psu.edu
% - wrote the code originally, using script_test_fcn_Laps_breakDataIntoLapIndices as starter
...
%% DEMO case: basic call with 4 tires
figNum = 10001;
titleString = sprintf('DEMO case: basic call with 4 tires');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
figure(figNum); clf;

% Load some test data
[time, latTireForces] = fcn_INTERNAL_loadExampleData;
...
% Call the function
fcn_VD_plotTimeLateralTireForce(time, latTireForces, ([]))
...
% Call the function
fcn_VD_plotTimeLateralTireForce(time, latTireForces, (-1))
...
function [time, latTireForces] = fcn_INTERNAL_loadExampleData
    
filename = fullfile(pwd,'Data','testing_data_for_plotTimeLateralTireForce');
load(filename,'time','latTireForces')
