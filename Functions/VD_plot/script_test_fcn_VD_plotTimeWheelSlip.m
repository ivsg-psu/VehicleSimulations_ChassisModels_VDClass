% script_test_fcn_VD_plotTimeWheelSlip.m
% tests fcn_VD_plotTimeWheelSlip.m
...
% Load some test data
[time, wheelSlips] = fcn_INTERNAL_loadExampleData;
...
% Call the function
fcn_VD_plotTimeWheelSlip(time, wheelSlips, ([]))
...
% Call the function
fcn_VD_plotTimeWheelSlip(time, wheelSlips, (-1))
...
function [time, wheelSlips] = fcn_INTERNAL_loadExampleData
    
filename = fullfile(pwd,'Data','testing_data_for_plotTimeWheelSlip');
load(filename,'time','wheelSlips')
