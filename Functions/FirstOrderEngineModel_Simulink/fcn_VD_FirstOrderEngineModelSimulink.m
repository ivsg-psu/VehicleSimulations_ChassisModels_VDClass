function [stateTrajectory, t, inputHistory] = fcn_VD_FirstOrderEngineModelSimulink(initialStates, deltaT, timeInterval, inputsVsTime, parameters, varargin)

%% fcn_VD_FirstOrderEngineModelSimulink
...
%      fcn_VD_FirstOrderEngineModel
%
% EXAMPLES:
%
%     See the script: script_test_fcn_VD_FirstOrderEngineModelSimulink
...
if 1==0
	nameRootString = 'mdl_VD_FirstOrderEngineModel';
...
stateTrajectory = nan(shorter_index,N_variables);
t = nan(shorter_index,1);

% Fill in the results to save
t(:,1)                 = simout.simTime(1:shorter_index,1); % Update time
inputHistory           = simout.inputUsed(1:shorter_index,1);
stateTrajectory(:,1)   = simout.Omega(1:shorter_index,1);
