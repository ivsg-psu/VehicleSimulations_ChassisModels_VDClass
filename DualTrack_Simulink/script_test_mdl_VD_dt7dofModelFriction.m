%% script_test_mdl_VD_dt7dofModelFriction.m
% Plots the results of outputs of a simulink model: 'mdl_VD_dt7dofModelFriction'
% It uses double-track vehicle model and brush tire model.
%
% Author: Wushuang and Satya Prasad on 2021/07/08
% Questions or comments? szm888@psu.edu

% REVISION HISTORY:
%
% 2021_07_08 by Satya Prasad, szm888@psu.edu
...
wheel_torque = [0, 0, 3, 3]; % wheel torque [Nm]
...
sim('mdl_VD_dt7dofModelFriction.slx', TotalTime);
...
fcn_VD_plotTimeLongitudinalAcceleration(time, States(:,8));
fcn_VD_plotTimeLateralAcceleration(time, States(:,9));
...
fcn_VD_plotTimeWheelSpeed(time, States(:,(4:7)));
