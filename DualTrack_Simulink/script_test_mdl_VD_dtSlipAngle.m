%% script_test_mdl_VD_dtSlipAngle.m
% Plots the results of outputs of a simulink model: 'mdl_VD_dtSlipAngle'.
...
% Define a MATLAB structure that specifies the physical properties for a vehicle.
