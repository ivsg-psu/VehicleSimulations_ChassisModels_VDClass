...
clf
hold on
plot(time,aligning_moment(:,1),'b','Linewidth',2.4)
plot(time,aligning_moment(:,2),'r','Linewidth',1.2)
plot(time,aligning_moment(:,3),'m--','Linewidth',2.4)
plot(time,aligning_moment(:,4),'g--','Linewidth',1.2)
grid on
legend('FL','FR','RL','RR','Interpreter','latex','Fontsize',13,...
       'NumColumns',2,'Location','best')
set(gca,'Fontsize',13)
ylabel('Aligning Moment $[Nm]$','Interpreter','latex','Fontsize',18)
