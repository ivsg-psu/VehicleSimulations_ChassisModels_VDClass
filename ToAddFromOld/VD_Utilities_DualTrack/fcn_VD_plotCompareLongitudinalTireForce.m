...
%   ref_lon_tire_force, lon_tire_force: A Nx4 matrix of longitudinal tire force(s) [N]
...
subplot(2,2,1)
plot(ref_time, ref_lon_tire_force(:,1), 'b', 'Linewidth', 1)
hold on
plot(time, lon_tire_force(:,1), 'r--', 'Linewidth', 1)
grid on
...
subplot(2,2,2)
plot(ref_time, ref_lon_tire_force(:,2), 'b', 'Linewidth', 1)
hold on
plot(time, lon_tire_force(:,2), 'r--', 'Linewidth', 1)
grid on
legend(['FR ' ref_sim_name], ['FR ' sim_name], 'Location', 'best')
ylim([min_value-offset max_value+offset])

subplot(2,2,3)
plot(ref_time, ref_lon_tire_force(:,3), 'b', 'Linewidth', 1)
hold on
plot(time, lon_tire_force(:,3), 'r--', 'Linewidth', 1)
grid on
...
subplot(2,2,4)
plot(ref_time, ref_lon_tire_force(:,4), 'b', 'Linewidth', 1)
hold on
plot(time, lon_tire_force(:,4), 'r--', 'Linewidth', 1)
grid on
