...
%   lon_tire_force: A Nx4 matrix of longitudinal tire force(s) [N]
%
% Returned Results:
%   A plot
%
...
clf
hold on
plot(time,lon_tire_force(:,1),'b','Linewidth',2.4)
plot(time,lon_tire_force(:,2),'r','Linewidth',1.2)
plot(time,lon_tire_force(:,3),'m--','Linewidth',2.4)
plot(time,lon_tire_force(:,4),'g--','Linewidth',1.2)
grid on
legend('FL','FR','RL','RR','Interpreter','latex','Fontsize',13,...
       'NumColumns',2,'Location','best')
set(gca,'Fontsize',13)
ylabel('Longitudinal Tire Force $[N]$','Interpreter','latex','Fontsize',18)
