...
%   wheel_speed: A Nx4 matrix of wheel speed(s) [rad/s]
%
% Returned Results:
%   A plot
%
...
clf
hold on
plot(time,wheel_speed(:,1),'b','Linewidth',2.4)
plot(time,wheel_speed(:,2),'r','Linewidth',1.2)
plot(time,wheel_speed(:,3),'m--','Linewidth',2.4)
plot(time,wheel_speed(:,4),'g--','Linewidth',1.2)
grid on
