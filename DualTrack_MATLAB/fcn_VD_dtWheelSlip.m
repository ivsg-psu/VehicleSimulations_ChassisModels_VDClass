...
if flag_check_inputs
	...
	% Check the r input to be sure it has 1 col, 1 row, positive
	fcn_DebugTools_checkInputsToFunctions(r, '1column_of_numbers',[1 1]);

	% Check the wheel_angular_velocity input to be sure it has 4 col, 1+ rows
	fcn_DebugTools_checkInputsToFunctions(wheel_angular_velocity, '4column_of_numbers',[1 2]);
