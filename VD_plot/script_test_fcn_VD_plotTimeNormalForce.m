% script_test_fcn_VD_plotTimeNormalForce.m
% tests fcn_VD_plotTimeNormalForce.m
...
% Load some test data
[time, normalForces] = fcn_INTERNAL_loadExampleData;
...
% Call the function
fcn_VD_plotTimeNormalForce(time, normalForces, ([]))
...
% Call the function
fcn_VD_plotTimeNormalForce(time, normalForces, (-1))
...
function [time, normalForces] = fcn_INTERNAL_loadExampleData
    
filename = fullfile(pwd,'Data','testing_data_for_plotTimeNormalForce');
load(filename,'time','normalForces')
