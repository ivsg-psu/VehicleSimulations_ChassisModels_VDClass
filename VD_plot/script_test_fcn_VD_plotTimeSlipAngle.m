% script_test_fcn_VD_plotTimeSlipAngle.m
% tests fcn_VD_plotTimeSlipAngle.m
...
% Load some test data
[time, slipAngles] = fcn_INTERNAL_loadExampleData;
...
% Call the function
fcn_VD_plotTimeSlipAngle(time, slipAngles, ([]))
...
% Call the function
fcn_VD_plotTimeSlipAngle(time, slipAngles, (-1))
...
function [time, slipAngles] = fcn_INTERNAL_loadExampleData
    
filename = fullfile(pwd,'Data','testing_data_for_plotTimeSlipAngle');
load(filename,'time','slipAngles')
