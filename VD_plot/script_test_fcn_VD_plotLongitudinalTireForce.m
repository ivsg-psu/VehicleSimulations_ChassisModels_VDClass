% script_test_fcn_VD_plotTimeLongitudinalTireForce.m
% tests fcn_VD_plotTimeLongitudinalTireForce.m
...
% Load some test data
[time, longTireForces] = fcn_INTERNAL_loadExampleData;
...
% Call the function
fcn_VD_plotTimeLongitudinalTireForce(time, longTireForces, ([]))
...
% Call the function
fcn_VD_plotTimeLongitudinalTireForce(time, longTireForces, (-1))
...
function [time, longTireForces] = fcn_INTERNAL_loadExampleData
    
filename = fullfile(pwd,'Data','testing_data_for_plotTimeLongitudinalTireForce');
load(filename,'time','longTireForces')
