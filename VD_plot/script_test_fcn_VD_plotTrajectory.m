% script_test_fcn_VD_plotTrajectory.m
% tests fcn_VD_plotTrajectory.m
...
% Load some test data
trajectory = fcn_INTERNAL_loadExampleData;
...
% Call the function
fcn_VD_plotTrajectory(trajectory, ([]))
...
% Call the function
fcn_VD_plotTrajectory(trajectory, (-1))
...
function trajectory = fcn_INTERNAL_loadExampleData
