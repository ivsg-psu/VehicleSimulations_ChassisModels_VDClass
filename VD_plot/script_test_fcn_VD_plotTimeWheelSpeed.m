% script_test_fcn_VD_plotTimeWheelSpeed.m
% tests fcn_VD_plotTimeWheelSpeed.m
...
% Load some test data
[time, wheelSpeeds] = fcn_INTERNAL_loadExampleData;
...
% Call the function
fcn_VD_plotTimeWheelSpeed(time, wheelSpeeds, ([]))
...
% Call the function
fcn_VD_plotTimeWheelSpeed(time, wheelSpeeds, (-1))
...
function [time, wheelSpeeds] = fcn_INTERNAL_loadExampleData
    
filename = fullfile(pwd,'Data','testing_data_for_plotTimeWheelSpeed');
load(filename,'time','wheelSpeeds')
