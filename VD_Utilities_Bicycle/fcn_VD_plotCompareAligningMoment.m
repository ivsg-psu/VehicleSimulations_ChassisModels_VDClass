...
%   ref_aligning_moment, aligning_moment: A Nx2 matrix of aligning moment [Nm]
...
subplot(2,1,1)
plot(ref_time, ref_aligning_moment(:,1), 'b', 'Linewidth', 1.2)
hold on
plot(time, aligning_moment(:,1), 'r--', 'Linewidth', 1.2)
grid on
legend(['Front ' ref_sim_name], ['Front ' sim_name], 'Location', 'best',...
       'Interpreter','Latex','Fontsize',13)
set(gca,'Fontsize',13)
ylabel('Aligning Moment $[Nm]$','Interpreter','Latex','Fontsize',13)
ylim([min_value-offset max_value+offset])

subplot(2,1,2)
plot(ref_time, ref_aligning_moment(:,2), 'b', 'Linewidth', 1.2)
hold on
plot(time, aligning_moment(:,2), 'r--', 'Linewidth', 1.2)
grid on
